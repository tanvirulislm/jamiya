        ...
        @if ($kitabTeachers->count() > 0)
            ...
            <div class="grid md:grid-cols-3 lg:grid-cols-4 gap-8">
                @foreach ($kitabTeachers as $kt)
                    <div
                        class="bg-white border border-green-700 shadow-lg rounded-2xl px-4 py-[50px] hover:-translate-y-1 transition">
                        ...
                        <div class="mt-4 space-y-1 text-center text-gray-700">
                            ...
                            @if (!empty(trim($kt->email)))
                                <p class="text-sm">
                                    <i class="fa-solid fa-envelope mr-2 text-green-700"></i>
                                    {{ $kt->email }}
                                </p>
                            @endif
                        </div>
